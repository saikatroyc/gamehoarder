    ...
    <div class="container">
        <div class="page-header">
            <div class="clearfix">
                <div class="col-md-12 col-sm-6 col-xs-12 text-center">
                    ...
                    <p>GameHoarder will not collect any personal information about you aside from the information you provide to us (such as your email address, username, password, 
                    and data on your game collection). This information will not be published publicly and is only used for identification/security reasons.
                    </p>
                </div>
            </div>
        </div>
     ...
     <!-- FOOTER -->
      <div class="footer navbar-fixed-bottom">
        <p class="pull-right">&copy; 2014 GameHoarder; <a href="#">Privacy</a> &middot; <a href="terms.php">Terms</a> &middot; <a href="#">Back to top</a></p>
      </div>
